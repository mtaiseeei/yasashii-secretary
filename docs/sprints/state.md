...
- Current ID: sprint-004
- Retry Count: 0
- Next Planned: sprint-005

<!-- 2026-07-08: Codex GPT-5.5 high レビューの全指摘（High3/Medium4/Low2＋F7）は
     sprint-003-patch-001 で対応・合格済み。ユーザー指示の「レビュー修正後に sprint-004」条件を満たした。 -->
...
| sprint-004 | planned | [contract](sprint-004.md) | - | - |
| sprint-005 | planned | [contract](sprint-005.md) | - | - |
