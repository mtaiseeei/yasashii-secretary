...
| [sprint-033](sprints/sprint-033.md) | 上流版: 共通祖先から `agentic-secretary` を成立させ、技術者向けedition差分を実装 | sprint-032-patch-001 |
| [sprint-034](sprints/sprint-034.md) | 下流版: `yasashii-secretary` の狭いoverlayと同期回帰 | sprint-033 |
