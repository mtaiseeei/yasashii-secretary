...
| G9 | Google Chatを安全に蓄積する | 各社所有のGoogle Cloudプロジェクト、ユーザーOAuth、選択した通常スペース、同意済みGitHub Actionsを一続きにする |

## 詳細仕様

| ファイル | 内容 |
|---|---|
| [product.md](spec/product.md) | 目的、対象ユーザー、G1〜G9、成功状態、非ゴール |
| [features.md](spec/features.md) | F01〜F35 とユーザーから見た振る舞い |
