...
最後に作業中フォルダ全体を1つのprivate GitHub repoにし、最初のコミットと初回pushまで行います。
このrepoが秘書、通常のproject、Chatwork履歴をまとめる共通workspaceです。
...
3. remoteが無い場合は、repo名、privateであること、保存対象（秘書・通常project・Chatwork設定）を示して確認する。
...
- `AGENTS.md`、`MEMORY.md`等を用意し、作業中フォルダ全体を1つのprivate repoへ初回pushしたこと。
- private状態、remote、初回push結果。
- 次に試せる操作として /chatwork でroom接続へ進めることと、「設定はいつでも『設定変えたい』で変更できます」という案内。
