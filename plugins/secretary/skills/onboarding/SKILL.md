...
```text
node "${CLAUDE_PLUGIN_ROOT}/scripts/edition-guard.mjs" --workspace . --plugin-root "${CLAUDE_PLUGIN_ROOT}" --entry onboarding --prepare-new --json
```
