...
function renderSecret() {
  ...
  show("register-connection", `<p class="eyebrow">接続 2 / 4</p><h1>接続情報をGitHubへ登録します。</h1>
    ...
    <div class="panel"><p class="panel-title">GitHubの登録画面で入力する内容</p>
      <dl class="summary" data-copy-role="secret-instructions"><div class="summary-row"><dt><code>Name</code> 欄</dt><dd><code>CHATWORK_API_TOKEN</code></dd></div><div class="summary-row"><dt><code>Secret</code> 欄</dt><dd>Chatwork公式画面でご本人が取得したAPI Token</dd></div></dl>
      <p class="hint">API Tokenの実際の値はGitHubの登録画面にだけ入力します。このwizard、AIとの会話、リポジトリ、ログには貼り付けないでください。</p>
    ${technicalDetails("詳しい説明: GitHubでの保管方法", "<p>GitHub上の安全な保管場所は <strong>Repository Secret</strong> です。Tokenの値をこの画面で受け取ったり、リポジトリのファイルへ保存したりはしません。</p>")}</div>
...
function renderSecretConfirmation() {
  ...
  show("confirm-registration", `<p class="eyebrow">接続 3 / 4</p><h1>GitHubへの登録を確認します。</h1>
    ...
    <label class="consent"><input id="secret-confirmed" type="checkbox"><span><code>Name</code> 欄を <code>CHATWORK_API_TOKEN</code> にし、<code>Secret</code> 欄へChatwork公式画面で取得したAPI Tokenを登録しました</span></label>
    ${technicalDetails("詳しい説明: 確認する内容", "<p>Tokenの値は読み戻しません。GitHubの登録名だけを照合し、このwizard、AIとの会話、リポジトリ、ログには値を残しません。</p>")}
