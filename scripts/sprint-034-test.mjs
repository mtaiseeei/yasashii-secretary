...
check("edition metadata stays yasashii and current release is 0.10.3", () => {
  ...
  assert.equal(marketplace.plugins[0].version, "0.10.3");
  ...
  assert.equal(codexManifest.version, "0.10.3");
