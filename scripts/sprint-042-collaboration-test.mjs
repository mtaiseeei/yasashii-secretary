...
try {
  ...
  await test("CLX-020", "tracked inventoryは実path／marker／digest／testと双方向一致し負例を拒否", () => {
    const inventory = loadCollaborationInventory(repo); const valid = validateCollaborationInventory(repo, inventory); assert.deepEqual(valid, { surfaceCount: 20, caseCount: 57, digestsValid: true, markersValid: true });
