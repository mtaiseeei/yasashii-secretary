...
1. 会社のGoogle Workspace組織が所有するGoogle Cloudプロジェクトを作る。
...
3. [OAuth同意画面](https://developers.google.com/workspace/guides/configure-oauth-consent)のAudienceを `Internal` にする。
4. OAuth Clientを `Desktop app` として作り、client JSONを利用者へ安全に渡す。
